...
public interface AssetRegistrationHomeQueryMapper {
        ...
        // "d.field0180, " +
        // "d.formmain_id " +
        // "FROM formmain_1189 m " +
        // "LEFT JOIN formson_1190 d ON m.ID = d.formmain_id " +
        // "WHERE m.field0028 BETWEEN #{startDate} AND #{endDate}")
        // List<AssetRegistrationHomeWithDetailDTO> selectByDateRange(String startDate,
        // String endDate);
        ...
        List<DeletedHomeInfo> selectDeletedHomeInfo();

        // 添加内部类
        class DeletedHomeInfo {

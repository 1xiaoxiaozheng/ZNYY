...
public interface EquipCardInfoMapper extends BaseMapper<EquipCardInfo> {
    ...
    @Insert("INSERT INTO equip_card_info (" +
            ...
            "equip_code, equip_name, buy_cost, now_cost, buy_date, start_use_date, " +
            "expire_date, use_dept_code, use_dept_name, useful_life, " +
            "manufacturer_code, manufacturer_name, manufacture_no, purchase_operator, " +
            "accept_operator, manage_operator, invo_no, equip_hospital_code, " +
            "measure_code, retest_period, retest_unit, finance_fund, science_fund, " +
            "self_fund, receive_no, receive_date, receive_operator, house_area_square, " +
            "deprec_start_date, deprec_flag, deprec_type_code, deprec_type_name, " +
            "deprec_rate, mon_derp_amt, net_salvage_rate, net_salvage_cost, " +
            "equip_status_code, equip_status_name, audit_flag, reserve1, reserve2, " +
            ...
            "#{equipCode}, #{equipName}, #{buyCost}, #{nowCost}, #{buyDate}, #{startUseDate}, " +
            "#{expireDate}, #{useDeptCode}, #{useDeptName}, #{usefulLife}, " +
            "#{manufacturerCode}, #{manufacturerName}, #{manufactureNo}, #{purchaseOperator}, " +
            "#{acceptOperator}, #{manageOperator}, #{invoNo}, #{equipHospitalCode}, " +
            "#{measureCode}, #{retestPeriod}, #{retestUnit}, #{financeFund}, #{scienceFund}, " +
            "#{selfFund}, #{receiveNo}, #{receiveDate}, #{receiveOperator}, #{houseAreaSquare}, " +
            "#{deprecStartDate}, #{deprecFlag}, #{deprecTypeCode}, #{deprecTypeName}, " +
            "#{deprecRate}, #{monDerpAmt}, #{netSalvageRate}, #{netSalvageCost}, " +
            "#{equipStatusCode}, #{equipStatusName}, #{auditFlag}, #{reserve1}, #{reserve2}, " +
            "#{dataClctPrdrName}, #{crteTime}, #{updtTime}, #{deleted}, #{deletedTime}" +
            ")")

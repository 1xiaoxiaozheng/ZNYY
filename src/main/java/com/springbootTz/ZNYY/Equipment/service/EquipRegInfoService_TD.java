...
//                    System.out.println("跳过周宁总医院数据，单据编号: " + house.getField0001() + ", 单位: " + unitName);
                    skipCount++;
                    continue;
                }
...
//                    System.out.println("跳过rid为null的数据，单据编号: " + house.getField0001());
                    skipCount++;
                    continue;
                }
    ...
    private EquipRegInfo mapToEquipRegInfo(AssetRegistrationHouseWithDetailDTO house) {
        ...
        equipRegInfo.setCrteTime(house.getStartDate() != null ? house.getStartDate() : getCurrentTime());
        equipRegInfo.setUpdtTime(house.getStartDate() != null ? house.getStartDate() : getCurrentTime());

...
import com.springbootTz.ZNYY.Humanresource.entity.OraclePersonWork;
...
public class PersonWorkFieldMapper {
    ...
    /**
     * 反射设置OraclePersonWork属性（字段名需与OraclePersonWork属性一致，支持下划线转驼峰）
     * String类型赋值为字符串，Date/BigDecimal类型空字符串赋null，日期自动识别格式
     */
    public void setOracleField(OraclePersonWork oracle, String field, String value) {

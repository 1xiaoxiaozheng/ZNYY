...
/**
 * 实体类：HUM_PSN_TRAIN
 * 对应Oracle表HUM_PSN_TRAIN
 */
@Data
@TableName("HUM_PSN_TRAIN")
public class OraclePersonTrain implements Serializable {
    /** 数据唯一记录号 */
    ...
    /** 进修级别代码 */
    @TableField("TRAIN_GRADE_CODE")
    private String trainGradeCode;
    /** 进修级别名称 */
    @TableField("TRAIN_GRADE_NAME")
    private String trainGradeName;
    /** 进修单位 */
    @TableField("TRAIN_EMP")
    private String trainEmp;
    /** 进修专业 */
    @TableField("TRAIN_SUBJECT")
    private String trainSubject;
    /** 进修开始日期 */
    @TableField("TRAIN_BEGNDATE")
    private Date trainBegndate;
    /** 进修结束日期 */
    @TableField("TRAIN_ENDDATE")
